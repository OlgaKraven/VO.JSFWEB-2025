...
* Количество лабораторных: **6 лабораторных работ**
...
|---|------------------------------|-------------------------------|-------|
| 1 | Основы web-приложения и настройка среды разработки JavaScript | Изучение базовой структуры web-приложения, организация файлов проекта, настройка среды выполнения и редактора кода. Реализация первичного взаимодействия HTML-страницы и JavaScript-кода, подключение скриптов и вывод результатов в браузере. | 10 |
| 2 | Базовый синтаксис JavaScript и алгоритмическая логика | Освоение основных типов данных, операторов, условных конструкций и циклов. Реализация простых алгоритмов с пошаговым выполнением и анализом логики работы программы. | 10 |
| 3 | Функции и структуры данных для обработки информации | Разработка функций, работа с массивами и объектами, применение методов обработки данных. Реализация базовых CRUD-операций над данными в рамках JavaScript-приложения. | 10 |
| 4 | Асинхронные операции и получение данных в web-приложении | Изучение асинхронного выполнения кода, использование `fetch` для получения данных, обработка ошибок и организация взаимодействия с внешними источниками данных. | 10 |
| 5 | Работа с DOM и обработка пользовательских событий | Освоение методов поиска и изменения элементов DOM, динамическое управление интерфейсом web-приложения. Реализация обработки пользовательских событий (клики, ввод данных, изменения состояния). | 10 |
| 6 | Формы, валидация данных и качество кода web-приложения | Реализация обработки данных HTML-форм, применение регулярных выражений для валидации ввода, отладка приложения и улучшение качества кода с использованием базовых принципов чистого кода. | 10 |
|   | **Итого** |  | **60** |
